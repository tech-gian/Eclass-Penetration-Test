...
function upgrade_course_2_2($code, $lang, $extramessage = '')
{
	...
	// upgrade exercises
 	db_query("ALTER TABLE `exercise_user_record` 
		CHANGE `RecordStartDate` `RecordStartDate` DATETIME NOT NULL default '1970-01-01'", $code); 
 	db_query("ALTER TABLE `exercise_user_record` 
		CHANGE `RecordEndDate` `RecordEndDate` DATETIME NOT NULL default '1970-01-01'", $code);
	...
	while ($dbox = mysql_fetch_array($d)) {
        ...
        if (!mysql_table_exists($code, 'assignments'))  {
                db_query("CREATE TABLE `assignments` (
                        ...
                        `deadline` date NOT NULL default '1970-01-01',
                        `submission_date` date NOT NULL default '1970-01-01',
        ...
        if (!mysql_table_exists($code, 'assignment_submit')) {
                db_query("CREATE TABLE `assignment_submit` (
                        ...
                        `grade_comments` text,
                        `grade_submission_date` date NOT NULL default '1970-01-01',
        ...
        if (!mysql_table_exists($code, 'dropbox_file'))  {
                ...
                db_query("CREATE TABLE dropbox_file (
                        id int(11) unsigned NOT NULL auto_increment,
                           ...
                           uploadDate datetime NOT NULL default '1970-01-01 00:00:00',
                           lastUploadDate datetime NOT NULL default '1970-01-01 00:00:00',
                           PRIMARY KEY (id),
        ...
        if (!mysql_table_exists($code, 'wiki_pages'))  {
                db_query("CREATE TABLE `wiki_pages` (
                        ...
                        `last_mtime` datetime NOT NULL default '1970-01-01 00:00:00',
                        PRIMARY KEY  (`id`)
                                ) ", $code);
        }
        ...
        if (!mysql_table_exists($code, 'poll'))  {
                ...
                db_query("ALTER TABLE `poll` CHANGE `creation_date` `creation_date` DATE NOT NULL default '1970-01-01'", $code);
                db_query("ALTER TABLE `poll` CHANGE `start_date` `start_date` DATE NOT NULL default '1970-01-01'", $code);
                db_query("ALTER TABLE `poll` CHANGE `end_date` `end_date` DATE NOT NULL default '1970-01-01'", $code);
        }
        ...
        if (!mysql_field_exists("$code",'poll_answer_record', 'submit_date'))
                echo add_field('poll_answer_record', 'submit_date', "DATE NOT NULL default '1970-01-01'");
        ...
        if (!mysql_table_exists($code, 'exercise_user_record'))  {
                db_query("CREATE TABLE `exercise_user_record` (
                        ...
                        `RecordStartDate` date NOT NULL default '1970-01-01',
                        `RecordEndDate` date NOT NULL default '1970-01-01',
        ...
        if (!mysql_field_exists("$code",'exercices','StartDate'))
                echo add_field_after_field('exercices', 'StartDate', 'type', "DATE NOT NULL default '1970-01-01'");
        else
        ...
        if (!mysql_field_exists("$code",'exercices','EndDate'))
                echo add_field_after_field('exercices', 'EndDate', 'StartDate', "DATE NOT NULL default '1970-01-01'");
        else
