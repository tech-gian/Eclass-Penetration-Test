...
if (isset($_POST['PollCreate']) && validate_csrf_token())  {
...
function printPollCreationForm() {
    ...
    */
	...
	if (isset($_POST['MoreMultiple']) && validate_csrf_token() ) {
		$questions[] = '';
		$question_types[] = 1;
	} elseif (isset($_POST['MoreFill']) && validate_csrf_token()) {
		$questions[] = '';
		$question_types[] = 2;
	}
...
function add_multiple_choice_question($i, $text)
{
	...
	if (isset($_POST['MoreAnswers'.$i]) && validate_csrf_token() ) {
		$answers[] = '';
	}
	$tool_content .= "
    <tr>
