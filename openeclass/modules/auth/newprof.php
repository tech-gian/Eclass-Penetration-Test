...
$registration_errors = array();
    ...
    if (count($registration_errors) == 0) {    // registration is ok
            ...
            $tempSql = $conn->prepare("INSERT INTO prof_request SET
              profname = ?,
              profsurname = ?,
              profuname = ?,
              profemail = ?,
              ...
              comment = ?,
              lang = ?");
            $tempSql->bind_param("ssssssss", $prenom_form, $nom_form, $uname, $email_form, $department, $userphone, $usercomment, $proflang);
            $tempSql->execute();
