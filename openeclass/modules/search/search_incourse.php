	...
	******************************************************************************************************/
    ...
    <tr>
      ...
      <td><div class=\"Results\">";
		...
		$tempSql = $conn->prepare("SELECT * FROM annonces WHERE cours_id = ? AND MATCH (contenu)".$query);
	...
	if($sbsystems["1"] == "1") {
		...
		<td><div class=\"Results\">";
		$myquery = $conn->prepare("SELECT * FROM agenda WHERE MATCH (titre,contenu)".$query);
		$myquery->execute();
	...
	if($sbsystems["20"] == "1") {
		...
		<td><div class=\"Results\">";
		$myquery = $conn->prepare("SELECT * FROM course_description WHERE MATCH (title,content)".$query);
		$myquery->execute();
		$result = $myquery->get_result();
		$c = 0;
		if(mysqli_num_rows($result) > 0) {
	...
	if($sbsystems["3"] == "1")
	{
		...
		<td><div class=\"Results\">";
		$myquery = $conn->prepare("SELECT * FROM document WHERE MATCH (filename,comment,title,creator,subject,description,author,language)".$query);
		$myquery->execute();
		$result = $myquery->get_result();
		$c = 0;
		if(mysqli_num_rows($result) > 0)
	...
	if($sbsystems["10"] == 1)
	{
		...
		<td><div class=\"Results\">";
			$myquery = $conn->prepare("SELECT * FROM exercices WHERE MATCH (titre,description)".$query);
			$myquery->execute();
			$result = $myquery->get_result();
			$c = 0;
			if(mysqli_num_rows($result) > 0)
	...
	if($sbsystems["9"] == 1)
	{
		...
		<td><div class=\"Results\">";
			$myquery = $conn->prepare("SELECT * FROM posts_text WHERE MATCH (post_text)".$query);
			$myquery->execute();
			$result = $myquery->get_result();
			...
			$myquery = $conn->prepare("SELECT * FROM forums WHERE MATCH (forum_name,forum_desc)".$query);
			$myquery->execute();
			$result = $myquery->get_result();
	...
	if($sbsystems["2"] == 1)
	{
		...
		$myquery = $conn->prepare("SELECT * FROM liens WHERE MATCH (url,titre,description)".$query);
		$myquery->execute();
		$result = $myquery->get_result();
		$c = 0;
		if(mysqli_num_rows($result) > 0)
	...
	if($sbsystems["4"] == 1)
	{
		...
		<td><div class=\"Results\">";
		$myquery = $conn->prepare("SELECT * FROM video WHERE MATCH (url,titre,description)".$query);
		$myquery->execute();
		$result = $myquery->get_result();
		$c = 0;
		if(mysqli_num_rows($result) > 0)
    ...
    <tr>
      ...
      <td><div class=\"Results\">";
		$myquery = $conn->prepare("SELECT * FROM videolinks WHERE MATCH (url,titre,description)".$query);
		$myquery->execute();
		$result = $myquery->get_result();
