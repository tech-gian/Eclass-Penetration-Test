...
db_query("CREATE TABLE `cours` (
  ...
  `lastVisit` date NOT NULL default '1970-01-01',
  `lastEdit` datetime NOT NULL default '1970-01-01 00:00:00',
  `expirationDate` datetime NOT NULL default '1970-01-01 00:00:00',
  `first_create` datetime NOT NULL default '1970-01-01 00:00:00',
...
db_query("CREATE TABLE user (
 	...
 	`announce_flag` date NOT NULL default '1970-01-01',
 	 `doc_flag` date NOT NULL default '1970-01-01',
    `forum_flag` date NOT NULL default '1970-01-01',
...
db_query("CREATE TABLE loginout (
      ...
      loginout.when datetime NOT NULL default '1970-01-01 00:00:00',
...
db_query("INSERT INTO loginout (loginout.id_user, loginout.ip, loginout.when, loginout.action) VALUES ('".$idOfAdmin."', '".$REMOTE_ADDR."', NOW(), 'LOGIN')");
...
db_query("CREATE TABLE `course_units` (
 ...
 db_query("CREATE TABLE `unit_resources` (
	...
	`visibility` CHAR(1) NOT NULL DEFAULT 'v',
	`order` INT(11) NOT NULL DEFAULT 0,
	`date` DATETIME NOT NULL DEFAULT '1970-01-01') $charset_spec");
